    ...
    <Wrapper headerRefs={headerRefs}>
      ...
      <div ref={bioRef} id="bio" className="section section-about">
        <div className="section-content">
          ...
          <p>
            I&apos;m a software engineer and freelance web developer based in
            Los Angeles. My path into development started at a hometown web
            agency, where I taught myself to build Wordpress and Magento
            websites for local businesses. That mix of creativity,
            problem-solving, and instant feedback from seeing a site come to
            life hooked me right away.
          </p>
          <p>
            In 2016, I began diving deeper into the Node.js ecosystem, exploring
            the backend side of development and modern JavaScript tooling. That
            path quickly led me to Next.js, where I found a framework that
            allowed me to build fast, scalable web applications at breakneck
            speeds.
          </p>
          <p>
            Lately, I&apos;ve been branching out creatively. I&apos;m currently
            teaching myself game development in Unity. On the side, I
            collaborate with friends on small web projects and experimental
            apps, the kind that start as late-night ideas and sometimes grow
            into something real. It keeps the work fun and reminds me why I got
            into this field in the first place &mdash; to keep exploring
      ...
      <div id="contact" className="section section-contact">
        <div className="section-content">
          <div className="content">
            ...
            <p>
              I am currently available for new opportunities. Whether you have a
          ...
          <ul className="links">
            <li className="link-wrap">
              <Link
                className="link"
                href="https://github.com/ewohlken2"
                target="_blank"
            ...
            <li className="link-wrap">
              <Link
                className="link"
                href="https://www.linkedin.com/in/elvis-wohlken/"
                target="_blank"
                rel="noopener noreferrer"
              >
                linkedin
            ...
            <li className="link-wrap">
              <Link
                className="link"
                href="https://github.com/ewohlken2/next-site"
                target="_blank"
                rel="noopener noreferrer"
              >
                source
