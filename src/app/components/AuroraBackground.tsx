...
const paletteStyles = {
  contact: {
    main:
      "radial-gradient(60% 50% at 50% 0%, rgba(83, 214, 255, 0.2) 0%, rgba(9, 11, 16, 0.9) 60%)",
    layer:
  ...
  cool: {
    main:
      "radial-gradient(60% 50% at 50% 0%, rgba(120, 224, 255, 0.16) 0%, rgba(8, 12, 18, 0.88) 60%)",
    layer:
  ...
  violet: {
    main:
      "radial-gradient(60% 50% at 50% 0%, rgba(181, 133, 255, 0.22) 0%, rgba(10, 10, 20, 0.9) 60%)",
    layer:
